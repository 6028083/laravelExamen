...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Wijzig blogs')
@section('content')
...
<form action="{{ route('posts.update-post',['post_id'=>Request('post_id')]) }}" method="post" id="editPostForm" enctype="multipart/form-data">
    @csrf
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-9">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="post_title" placeholder="Voer de berichttitel in" value="{{$post->post_title}}">
                        <span class="text-danger error-text post_title_error"></span>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Plaats inhoud</label>
                        <textarea class="ckeditor form-control" name="post_content" rows="6" placeholder="Inhoud.." id="post_content">{!! $post->post_content !!}</textarea>
                ...
                <div class="col-md-3">
                    ...
                    <button type="submit" class="btn btn-primary">Bericht bijwerken</button>
                </div>
            </div>
        </div>
    </div>
