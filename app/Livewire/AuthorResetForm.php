...
class AuthorResetForm extends Component
{
    ...
    public function ResetHandler()
    {
        ...
        if (!$check_token) {
            session()->flash('Fail', 'Invalide Token.');
        } else {
            ...
            session()->flash('succes', 'Your password has been updated succesfully. Login with your email (<span>' . $this->email . '</span> and your new password');

            $this->redirectRoute('auth.login', ['tkn' => $succes_token, 'UEmail' => $this->email]);
        }
    }
